...
?>
	<div class="container contenedor_1">
		<h2 class="h2_2">Registro de usuarios</h2> 
		<div class="row">
			<div class="col-sm-5 contenedor_9">
                            
				<form action="<?php echo site_url('/Registro_C/recibeRegistro');?>" method="POST" name="registroGratis" onsubmit="return validar_01()">
