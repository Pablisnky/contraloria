            ...
            <div class="contenedor_8">
                ...
                <div class="row contenedor_7">
                    <ul>
                        ...
                        <li class="li_1">El municipio San Felipe del estado Yaracuy es el unico disponible de la plataforma, si deseas que tu municipio este disponible lee los requerimientos en la sección <a href="<?php echo RUTA_URL . '/Participacion_C';?>"><label class="label_1 label_4">FAQ.</label></a></li>
                    </ul>     
                </div>   
                <div class="row">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li><a class="a_5">Educación secundaria</a></li>
                        <li><a class="a_5">Educación universitaria</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li><a class="a_5">Terminal de pasajeros</a></li>
                        <li><a class="a_5">carretera</a></li>
                        <li><a class="a_5">Autopista</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li class=""><a class="a_5">Telefono</a></li>
                        <li class=""><a class="a_5">Calles</a></li>
                        <li class=""><a class="a_5">Aseo urbano</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li><a class="a_5">Estadium</a></li>
                        <li><a class="a_5">Piscina</a></li>
                        <li><a class="a_5">Patinodromo</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li><a class="a_5">Librería</a></li>
                        <li><a class="a_5">Tienda de arte</a></li>
                        <li><a class="a_5">Museo</a></li>
                        <li><a class="a_5">Galería</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <ul class="ul_1">
                        ...
                        <li><a class="a_5">Mercado municipal</a></li>
                    </ul>
                </div>
                <div class="col-sm-4">
